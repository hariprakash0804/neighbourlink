...
import { MapPin, Heart, Shield, Phone, Mail, Send, ArrowRight, ArrowUp, Sparkles } from "lucide-react";
    ...
    <>
      ...
      {showScrollTop && (
        <motion.button
          ...
          onClick={scrollToTop}
          className="scroll-top-btn fixed bottom-24 lg:bottom-8 left-6 z-40 flex h-11 w-11 items-center justify-center rounded-full bg-gradient-to-br from-brand-primary to-brand-accent text-white shadow-lg hover:shadow-xl transition-all hover:scale-110 active:scale-90"
      ...
      <footer ref={footerRef} className="border-t border-white/10 bg-[var(--app-sidebar-bg)]" role="contentinfo">
        ...
        <div className="mx-auto max-w-7xl px-4 py-12">
          ...
          <motion.div
            ...
            className="mb-12 rounded-3xl aurora-bg p-8 md:p-10 text-white relative overflow-hidden"
          >
